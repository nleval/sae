...
int main()
{
     ...
     * Dans un second temps, ces contenus proviendront d'une base de données
     --------------------------------------------------------------------------------------*/
    QVector<Image> images;      // les images
    QVector<diapo> diaporamas;  // les diaporamas
    ...
    while (true)
    {
        ...
        unsigned int position = diaporamas[diaporamaCourant].getLocalisationImage()[imageCourante].getPos();
